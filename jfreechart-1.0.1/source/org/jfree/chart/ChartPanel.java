 ...
 *                   Onno vd Akker;
 *
 * $Id: ChartPanel.java,v 1.20.2.5 2005/12/02 14:27:09 mungady Exp $
 *
...
public class ChartPanel extends JPanel 
     ...
     *
     * @param flag  <code>true</code> indicate, that the buffer should be 
     *              refreshed.
     */
        ...
        if (this.useBuffer) {
            ...
            if (this.refreshBuffer) {
                ...
                if (scale) {
                    ...
                    this.chart.draw(
                        bufferG2, chartArea, this.anchor, this.info
                    );
                    bufferG2.setTransform(saved);
                }
                else {
                    this.chart.draw(
                        bufferG2, bufferArea, this.anchor, this.info
                    );
                }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals(PROPERTIES_COMMAND)) {
            ...
            zoomInDomain(this.zoomPoint.getX(), this.zoomPoint.getY());
        }
        else if (command.equals(ZOOM_IN_RANGE_COMMAND)) {
            zoomInRange(this.zoomPoint.getX(), this.zoomPoint.getY());
        }
            ...
            zoomOutDomain(this.zoomPoint.getX(), this.zoomPoint.getY());
        }
        else if (command.equals(ZOOM_OUT_RANGE_COMMAND)) {
            zoomOutRange(this.zoomPoint.getX(), this.zoomPoint.getY());
        }
