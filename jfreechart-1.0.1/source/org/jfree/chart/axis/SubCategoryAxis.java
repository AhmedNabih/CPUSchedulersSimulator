 ...
 * Contributor(s):   -;
 *
 * $Id: SubCategoryAxis.java,v 1.6.2.1 2005/10/25 20:37:34 mungady Exp $
 *
 * Changes
 * -------
...
public class SubCategoryAxis extends CategoryAxis 
    ...
    public AxisState draw(Graphics2D g2, 
        ...
        state = drawCategoryLabels(
            g2, dataArea, edge, state, plotState
        );
    ...
    protected AxisState drawSubCategoryLabels(Graphics2D g2,
        ...
        for (int categoryIndex = 0; categoryIndex < categoryCount; 
            ...
            if (edge == RectangleEdge.TOP) {
                x0 = getCategoryStart(
                    categoryIndex, categoryCount, dataArea, edge
                );
                x1 = getCategoryEnd(
                    categoryIndex, categoryCount, dataArea, edge
                );
            ...
            for (int i = 0; i < subCategoryCount; i++) {
                ...
                TextUtilities.drawRotatedString(
                    label, g2, xx, yy, TextAnchor.CENTER, 0.0, 
                    TextAnchor.CENTER
                );
            }
        }
