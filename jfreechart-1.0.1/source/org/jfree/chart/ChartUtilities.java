 ...
 *                   Xavier Poinsard;
 *
 * $Id: ChartUtilities.java,v 1.4.2.1 2005/10/25 16:50:20 mungady Exp $
 *
 * Changes
 * -------
...
public abstract class ChartUtilities {
    ...
    public static void writeChartAsPNG(OutputStream out,
        ...
        ChartUtilities.writeChartAsPNG(
            out, chart, width, height, null, encodeAlpha, compression
        );
    ...
    public static void writeChartAsPNG(OutputStream out,
        ...
        ChartUtilities.writeBufferedImageAsPNG(
            out, chartImage, encodeAlpha, compression
        );
    ...
    public static void writeBufferedImageAsPNG(OutputStream out,
        ...
        EncoderUtil.writeBufferedImage(
            image, ImageFormat.PNG, out, compression, encodeAlpha
        );
    }
    ...
    public static byte[] encodeAsPNG(BufferedImage image, boolean encodeAlpha, 
                                     int compression) 
        throws IOException {
        return EncoderUtil.encode(
            image, ImageFormat.PNG, compression, encodeAlpha
        );
    }
    ...
    public static void writeImageMap(PrintWriter writer,
        ...
        ImageMapUtilities.writeImageMap(
            writer, name, info, toolTipTagFragmentGenerator, 
    ...
    public static String getImageMap(String name, ChartRenderingInfo info) {
        return ImageMapUtilities.getImageMap(
            name,
            info,
            new StandardToolTipTagFragmentGenerator(),
            new StandardURLTagFragmentGenerator()
