 ...
 * Contributor(s):   -;
 *
 * $Id: StandardCategoryItemLabelGeneratorTests.java,v 1.1.2.1 2005/10/25 20:49:19 mungady Exp $
 *
 * Changes
 * -------
...
public class StandardCategoryItemLabelGeneratorTests extends TestCase {
    ...
    public void testGenerateLabel() {
        StandardCategoryItemLabelGenerator g 
            = new StandardCategoryItemLabelGenerator("{2}", new DecimalFormat("0.000"));
