 ...
 * Contributor(s):   -;
 *
 * $Id: DatasetUtilitiesTests.java,v 1.11.2.3 2005/10/27 12:46:43 mungady Exp $
 *
 * Changes
 * -------
...
public class DatasetUtilitiesTests extends TestCase {
    ...
    public void testCalculatePieDatasetTotal() {
        ...
        assertEquals(
            0.0, DatasetUtilities.calculatePieDatasetTotal(d), EPSILON
        );
        d.setValue("A", 1.0);
        assertEquals(
            1.0, DatasetUtilities.calculatePieDatasetTotal(d), EPSILON
        );
        d.setValue("B", 3.0);
        assertEquals(
            4.0, DatasetUtilities.calculatePieDatasetTotal(d), EPSILON
        ); 
    }
